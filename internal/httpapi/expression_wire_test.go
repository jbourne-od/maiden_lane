...
func exemplarExprs(t *testing.T) map[semantic.ExprKind]semantic.Expr {
	...
	return map[semantic.ExprKind]semantic.Expr{
		...
		semantic.ExprSubtract:      {Kind: semantic.ExprSubtract, Args: []semantic.Expr{number, number}},
		semantic.ExprMultiply:      {Kind: semantic.ExprMultiply, Args: []semantic.Expr{number, number}},
		semantic.ExprDivide:        {Kind: semantic.ExprDivide, Args: []semantic.Expr{number, number}},
		semantic.ExprModulo:        {Kind: semantic.ExprModulo, Args: []semantic.Expr{number, number}},
		semantic.ExprAbs:           {Kind: semantic.ExprAbs, Args: []semantic.Expr{number}},
		semantic.ExprClamp:         {Kind: semantic.ExprClamp, Args: []semantic.Expr{number, number, number}},
		semantic.ExprTimestampAdd:  {Kind: semantic.ExprTimestampAdd, Args: []semantic.Expr{field, number}},
		semantic.ExprTimestampDiff: {Kind: semantic.ExprTimestampDiff, Args: []semantic.Expr{field, field}},
		semantic.ExprDateExtract:   {Kind: semantic.ExprDateExtract, Field: "year", Args: []semantic.Expr{field}},
		semantic.ExprConcat:        {Kind: semantic.ExprConcat, Args: []semantic.Expr{field, field}},
		semantic.ExprSubstring:     {Kind: semantic.ExprSubstring, Args: []semantic.Expr{field, number, number}},
		semantic.ExprTrim:          {Kind: semantic.ExprTrim, Args: []semantic.Expr{field}},
		semantic.ExprIf:            {Kind: semantic.ExprIf, Args: []semantic.Expr{exists, field, field}},
		semantic.ExprCoalesce:      {Kind: semantic.ExprCoalesce, Args: []semantic.Expr{field, field}},
	}
}
